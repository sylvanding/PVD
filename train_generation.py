...
def parse_args():
    ...
    parser.add_argument('--bs', type=int, default=1 if fast_dev_run else 2, help='input batch size')
    ...
    parser.add_argument('--lr', type=float, default=1e-4, help='learning rate for E, default=2e-4')
    ...
    parser.add_argument('--diagIter', default=1 if fast_dev_run else 1, help='unit: epoch')
